...
const Carousel = () => {
  ...
  return (
    <div className="relative h-[70vh] overflow-hidden rounded-lg shadow-divine">
          ...
          >
            ...
            <div className="relative h-full flex items-center justify-center text-center">
              <div className="max-w-4xl mx-auto px-4 animate-fade-in-up">
                ...
                <Button variant="golden" size="lg" className="animate-gentle-float">
                  Join Us This Sunday
                </Button>
              </div>
            </div>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute left-4 top-1/2 transform -translate-y-1/2 text-sacred-white hover:bg-sacred-white/20"
        onClick={prevSlide}
      >
        <ChevronLeft size={24} />
      </Button>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-sacred-white hover:bg-sacred-white/20"
        onClick={nextSlide}
      >
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 ${
              index === currentSlide ? "bg-golden-light" : "bg-sacred-white/50"
            }`}
